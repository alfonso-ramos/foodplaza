...
public class LocalService {
    ...
    public List<Local> obtenerLocalesPorPlaza(Long plazaId) {
        ...
        // Datos de ejemplo
        if (plazaId == 1L) {
            Local local1 = new Local(1L, 1L, "Restaurante La Esquina", "Comida mexicana tradicional", "Local 12", "09:00", "22:00", "Restaurante");
            Local local2 = new Local(2L, 1L, "Café Aromas", "Café de especialidad y repostería", "Local 15", "07:00", "21:00", "Cafetería");
            locales.add(local1);
            locales.add(local2);
        }
